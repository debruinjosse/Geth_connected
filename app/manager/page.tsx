...
import { Bell, Download, Heart, UserRound, UsersRound } from "lucide-react";
    ...
    return (
      ...
      >
        <section className="metrics-grid">
          ...
          <MetricCard icon={<Bell />} value="4" label="Signals" />
        </section>
        ...
        <section className="dashboard-grid three">
          ...
          <article className="panel dashboard-panel">
            ...
            <div className="impact-card">
              <div className="hero-growth-badge">&uarr;</div>
              <strong style={{ display: "block", marginTop: 18, fontSize: 52, color: "var(--theme-ink-soft)" }}>+23%</strong>
              <p style={{ margin: "8px 0 0", color: "var(--theme-muted)" }}>increase in team recognition compared to last quarter.</p>
            </div>
          </article>
        </section>
      </DashboardShell>
  ...
  if (!teamIds.length) {
    return (
      <DashboardShell
        ...
        actions={
          <>
            <span className="quality-pill">Live data</span>
            <a className="btn btn-secondary" href="/manager/reports">
              <Download size={16} /> Export
            </a>
          </>
      ...
      >
        <section className="metrics-grid">
          ...
          <MetricCard icon={<Bell />} value="0" label="Signals" />
        </section>
        ...
        <section className="dashboard-grid three">
          <article className="panel dashboard-panel">
            <EmptyState eyebrow="Trend unavailable" title="Recognition trend will appear here" copy="Your trend chart will populate after your managed team starts receiving recognitions." />
          </article>
          <article className="panel dashboard-panel">
  ...
  return (
    ...
    >
      <section className="metrics-grid">
        ...
        <MetricCard icon={<Bell />} value={signalItems.length} label="Signals" />
      </section>
      ...
      <section className="dashboard-grid three">
        <article className="panel dashboard-panel">
          ...
          {recognitions.length ? (
            ...
            <EmptyState eyebrow="No trend yet" title="Recognition trend will appear here" copy="Once your team starts receiving recognitions, this chart will show monthly momentum." />
          )}
        </article>
        <article className="panel dashboard-panel">
          <div className="panel-top">
