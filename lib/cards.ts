...
export type SupportedCardLocale = "en" | "nl";
...
const cardTitleTranslations: Record<string, Record<SupportedCardLocale, string>> = {
  luisteraar: { en: "Listener", nl: "Luisteraar" },
  helder: { en: "Clear", nl: "Helder" },
  eerlijk: { en: "Honest", nl: "Eerlijk" },
  verbinder: { en: "Connector", nl: "Verbinder" },
  empathisch: { en: "Empathetic", nl: "Empathisch" },
  overtuigend: { en: "Persuasive", nl: "Overtuigend" },
  gastvrij: { en: "Welcoming", nl: "Gastvrij" },
  inspirerend: { en: "Inspiring", nl: "Inspirerend" },
  diplomatiek: { en: "Diplomatic", nl: "Diplomatiek" },
  leidend: { en: "Guiding", nl: "Leidend" },
  nieuwsgierig: { en: "Curious", nl: "Nieuwsgierig" },
  enthousiast: { en: "Enthusiastic", nl: "Enthousiast" },
  geruststeller: { en: "Reassurer", nl: "Geruststeller" },
  vernieuwend: { en: "Innovative", nl: "Vernieuwend" },
  avontuurlijk: { en: "Adventurous", nl: "Avontuurlijk" },
  humor: { en: "Humor", nl: "Humor" },
  visionair: { en: "Visionary", nl: "Visionair" },
  onderzoekend: { en: "Investigative", nl: "Onderzoekend" },
  authentiek: { en: "Authentic", nl: "Authentiek" },
  opmerkzaam: { en: "Observant", nl: "Opmerkzaam" },
  verzorgd: { en: "Thoughtful", nl: "Verzorgd" },
  oplosser: { en: "Problem solver", nl: "Oplosser" },
  intuitief: { en: "Intuitive", nl: "Intuitief" },
  improvisator: { en: "Improviser", nl: "Improvisator" },
  uitdager: { en: "Challenger", nl: "Uitdager" },
  dromer: { en: "Dreamer", nl: "Dromer" },
  doelgericht: { en: "Goal-oriented", nl: "Doelgericht" },
  analytisch: { en: "Analytical", nl: "Analytisch" },
  betrouwbaar: { en: "Reliable", nl: "Betrouwbaar" },
  strategisch: { en: "Strategic", nl: "Strategisch" },
  nauwkeurig: { en: "Precise", nl: "Nauwkeurig" },
  daadkrachtig: { en: "Decisive", nl: "Daadkrachtig" },
  leergierig: { en: "Eager to learn", nl: "Leergierig" },
  organisator: { en: "Organizer", nl: "Organisator" },
  veerkrachtig: { en: "Resilient", nl: "Veerkrachtig" },
  resultaatgericht: { en: "Results-driven", nl: "Resultaatgericht" },
  proactief: { en: "Proactive", nl: "Proactief" },
  besluitvaardig: { en: "Decision maker", nl: "Besluitvaardig" },
  kritisch: { en: "Critical thinker", nl: "Kritisch" },
  zorgzaam: { en: "Caring", nl: "Zorgzaam" },
  loyaal: { en: "Loyal", nl: "Loyaal" },
  teamspeler: { en: "Team player", nl: "Teamspeler" },
  vertrouwenspersoon: { en: "Trusted person", nl: "Vertrouwenspersoon" },
  ondersteunend: { en: "Supportive", nl: "Ondersteunend" },
  respectvol: { en: "Respectful", nl: "Respectvol" },
  dankbaar: { en: "Grateful", nl: "Dankbaar" },
  inclusief: { en: "Inclusive", nl: "Inclusief" },
  geduldig: { en: "Patient", nl: "Geduldig" },
  beschermend: { en: "Protective", nl: "Beschermend" },
  energiek: { en: "Energetic", nl: "Energiek" },
  aanwezig: { en: "Present", nl: "Aanwezig" },
  waarderend: { en: "Appreciative", nl: "Waarderend" },
  "open-categorie": { en: "Open Category", nl: "Open Categorie" }
};

function normalizeLocale(locale?: string): SupportedCardLocale {
  if (locale === "nl") return locale;
  return "en";
}
