export function buildEmployeeInsightSystemPrompt(locale: "en" | "nl") {
  ...
  return [
    ...
    "",
    "Detect Patterns",
    "If the recognitions reveal recurring themes or combinations of strengths, explicitly mention them.",
    ...
    "- Never invent strengths that are not supported by the recognition data.",
